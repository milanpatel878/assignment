...
<div class="container mt-5 mb-5">
 ...
 <div class="container-fluid footer p-4"><br>
    <div class="row">
    <hr>
    <p class="text-center"><span class="text-success bi bi-gift"> </span> become a seller &nbsp; &nbsp; &nbsp;<span class="text-success bi bi-gift"></span> Advertise &nbsp; &nbsp; &nbsp;<span class="text-success bi bi-gift"> </span> Help Center  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; @2022 SellMyCar All Right Reserved By MILAN GONDALIYA &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; 
        <br><br>
